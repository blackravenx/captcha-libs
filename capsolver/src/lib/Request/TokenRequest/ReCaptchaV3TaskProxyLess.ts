...
type ReCaptchaV3TaskProxyLessParams =ProxylessTaskParams<Omit<RecaptchaV3TaskBaseParams, "_endpoint" | "type">>;
 ...
 */
export class ReCaptchaV3TaskProxyLess extends RecaptchaV3TaskBase {
