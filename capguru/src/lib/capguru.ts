...
import { CapGuruSolution } from "./Solution/_BaseSolution";
import {
  AmazonCarPathTask,
  AmazonPuzzleTask,
...
import { CoordinatesSolution } from "./Solution/GenericPuzzleSolution";
import { HCaptchaTask } from "./Request/Token/HCaptchaTask";
